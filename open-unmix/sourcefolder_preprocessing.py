...
Preprocessing steps for the SourceFolderDataset type (sourcefolder)

One folder for the target and other folders for the interference, randomly mixed as input of the model

Split train valid then create samples of 6 seconds of each STEMS in there designated split folder
